...
URL(endpoint): /v1/answer/{answerId}/comment
...
| Key | Data-Type | Description | Condition |
| --- | --- | --- | --- |
| nickname | string | 댓글을 작성한 사용자의 닉네임 | |
| password | string | 댓글을 작성한 사용자가 본인 확인을 위해 입력한 비밀번호 | |
| content | string | 댓글의 내용 | |
| createdAt | string | 댓글을 작성한 시간 | 댓글을 작성하여 작성하기 버튼을 누른 시점을 기준으로 할 것 |
